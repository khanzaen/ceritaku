        ...
        <div class="bg-white dark:bg-slate-800 backdrop-blur-lg rounded-lg shadow-2xl border border-white/20 dark:border-slate-700">
            ...
            <div class="px-6 pb-6 pt-6">
                ...
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-sm font-bold text-slate-900 dark:text-slate-100 mb-1">Welcome back</h2>
                    <p class="text-xs text-slate-600 dark:text-slate-400">Continue your reading journey</p>
                </div>
                ...
                <form id="loginForm" method="POST" action="<?= base_url('/auth/login') ?>">
                    ...
                    <div class="mb-3">
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword('login_password')" class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300">
                    ...
                    <div class="flex items-center justify-between mb-4 text-xs">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="remember" class="w-4 h-4 text-accent border-slate-300 dark:border-slate-600 rounded focus:ring-accent">
                            <span class="ml-2 text-slate-600 dark:text-slate-400">Remember me</span>
                        </label>
                        <a href="#" class="text-accent hover:text-purple-700 font-medium">Forgot password?</a>
                    </div>

                    <!-- Error Message -->
                    <div id="loginError" class="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700 hidden">
                    ...
                    <p class="text-center text-xs text-slate-600 dark:text-slate-400">
                        ...
                        <button type="button" onclick="switchModal('loginModal', 'registerModal')" class="text-accent hover:text-purple-700 font-semibold">
                            Sign up
                        </button>
                    </p>
