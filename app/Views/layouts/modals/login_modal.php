    ...
    <div class="w-full max-w-2xl mx-auto">
        <div class="bg-white shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[400px]">
            ...
            <div class="hidden md:flex md:w-1/2 bg-gray-50">
                <img src="<?= base_url('assets/images/login_ilustration2.jpg') ?>" alt="Login Illustration"
            ...
            <div class="w-full md:w-1/2 px-6 md:px-10 py-4 md:py-8 flex flex-col justify-center">
                ...
                <div class="mb-4 text-center">
                    <h2 class="font-serif text-xl md:text-2xl text-gray-800 mb-1">Welcome Back</h2>
                ...
                <form id="loginForm" method="POST" action="<?= base_url('/auth/login') ?>" class="space-y-4">
                    ...
                    <div id="loginError" class="hidden p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700">
                ...
                <p class="text-center text-xs text-gray-400 mt-4 mb-2">
                    Or continue with
                    <a href="#" class="text-[#6c5ce7] font-medium" onclick="openModal('registerModal')">Sign up now</a>
                </p>
