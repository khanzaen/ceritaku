...
class ChapterSeeder extends Seeder
{
    public function run()
    {
        ...
        foreach ($storyIds as $storyId) {
            $chapterCount = $faker->numberBetween(1, 2);
            for ($i = 0; $i < $chapterCount; $i++) {
                $chapterNumber = $nextChapterNumber[$storyId]++;
                $data[] = [
                    ...
                    'status' => $faker->randomElement(['PUBLISHED', 'PUBLISHED', 'DRAFT', 'ARCHIVED']),
